...
namespace T0001
{
    public partial class Allocate
    {
        public Allocate()
        {
            AllocateD = new HashSet<AllocateD>();
            AllocateDMerge = new HashSet<AllocateDMerge>();
        }
        ...
        /// <summary>
        /// 自定义1  0:普通调拨   1：出库调拨至备料储位   2：备料储位回库
        /// </summary>
        ...
        public virtual ICollection<AllocateD> AllocateD { get; set; }
        public virtual ICollection<AllocateDMerge> AllocateDMerge { get; set; }
    }
}